...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:bg-white lg:dark:bg-gray-900 lg:border-r lg:border-gray-200 lg:dark:border-gray-800 lg:sticky lg:top-0 lg:h-screen">
        {/* Header */}
        <div className="flex items-center p-6 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-secondary dark:text-white">NovaPay</span>
          </div>
        </div>
